...
import course_1_thumbnail from '@/assets/course_1.png'
import course_2_thumbnail from '@/assets/course_2.png'
import course_3_thumbnail from '@/assets/course_3.png'
import course_4_thumbnail from '@/assets/course_4.png'
import star from '@/assets/rating_star.svg'
import star_blank from '@/assets/star_dull_icon.svg'
...
type AssetsType = {
  ...
  sketch: StaticImageData;
  microsoft_logo: StaticImageData;
  walmart_logo: StaticImageData;
  accenture_logo: StaticImageData;
  adobe_logo: StaticImageData;
  paypal_logo: StaticImageData;
  course_1_thumbnail: StaticImageData;
  course_2_thumbnail: StaticImageData;
  course_3_thumbnail: StaticImageData;
  course_4_thumbnail: StaticImageData;
  star: StaticImageData;
  star_blank: StaticImageData;
  arrow_icon: StaticImageData;
  down_arrow_icon: StaticImageData;
  time_left_clock_icon: StaticImageData;
  time_clock_icon: StaticImageData;
  user_icon: StaticImageData;
  home_icon: StaticImageData;
  add_icon: StaticImageData;
  my_course_icon: StaticImageData;
  person_tick_icon: StaticImageData;
  facebook_icon: StaticImageData;
  instagram_icon: StaticImageData;
  twitter_icon: StaticImageData;
  file_upload_icon: StaticImageData;
  appointments_icon: StaticImageData;
  earning_icon: StaticImageData;
  dropdown_icon: StaticImageData;
  patients_icon: StaticImageData;
  play_icon: StaticImageData;
  blue_tick_icon: StaticImageData;
  lesson_icon: StaticImageData;
  course_4: StaticImageData;
  profile_img: StaticImageData;
  profile_img2: StaticImageData;
  profile_img3: StaticImageData;
};
...
export interface Course {
  _id: string;
  courseTitle: string;
  courseDescription: string; // contains HTML
  coursePrice: number;
  isPublished: boolean;
  discount: number;
...
export const dummyEducatorData:EducatorUser = {
...
export const dummyTestimonial:Testimonial[] = [
    {
        name: 'Donald Jackman',
        role: 'SWE 1 @ Amazon',
        image: profile_img,
...
export const dummyDashboardData:EducatorDashboard = {
...
export const dummyStudentEnrolled:Enrollment[] = [
    {
        "student": {
            "_id": "user_2qQlvXyr02B4Bq6hT0Gvaa5fT9V",
            "name": "GreatStack",
